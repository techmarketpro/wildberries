...
class CardsUpdateBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $WildberriesModelName = 'cards_update_body';
...
'nm_id' => 'int',
'vendor_code' => 'string',
'sizes' => '\Wildberries\Client\Model\Contentv1cardsupdateSizes[]',
...
'characteristics' => 'getCharacteristics'    ];
     ...
     * Gets sizes
     *
     * @return \Wildberries\Client\Model\Contentv1cardsupdateSizes[]
     */
     ...
     * Sets sizes
     *
     * @param \Wildberries\Client\Model\Contentv1cardsupdateSizes[] $sizes Массив размеров для номенклатуры (для безразмерного товара все равно нужно передавать данный массив без параметров (`wbSize` и `techSize`), но с ценой и баркодом)
     *
     * @return $this
     */
