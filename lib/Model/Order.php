...
class Order implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $WildberriesModelName = 'Order';
...
'priority_sc' => 'string[]',
'offices' => 'string[]',
'address' => '\Wildberries\Client\Model\OrderAddress',
...
self::DELIVERY_TYPE_FBS,        ];
     ...
     * Gets address
     *
     * @return \Wildberries\Client\Model\OrderAddress
     */
     ...
     * Sets address
     *
     * @param \Wildberries\Client\Model\OrderAddress $address address
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param int $price Цена в валюте продажи с учетом всех скидок, умноженная на 100. Код валюты продажи в поле currencyCode.
     *
     * @return $this
     */
     ...
     *
     * @param int $converted_price Цена в валюте продажи с учетом всех скидок, сконвертированная по курсу на момент продажи в российские копейки. Предоставляется в информационных целях.
     *
     * @return $this
     */
