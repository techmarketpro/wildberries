...
class UploadAddBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $WildberriesModelName = 'upload_add_body';
    ...
    protected static $WildberriesTypes = [
        'vendor_code' => 'string',
'cards' => '\Wildberries\Client\Model\Contentv1cardsuploadaddCards[]'    ];
...
'cards' => 'getCards'    ];
     ...
     * Gets cards
     *
     * @return \Wildberries\Client\Model\Contentv1cardsuploadaddCards[]
     */
     ...
     * Sets cards
     *
     * @param \Wildberries\Client\Model\Contentv1cardsuploadaddCards[] $cards Массив НМ которые хотим добавить к КТ
     *
     * @return $this
     */
